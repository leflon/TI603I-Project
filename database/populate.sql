...
VALUES 
('G0000001', 'Carcassonne', 29.99, 'Tile-placement game where players build medieval landscapes.', 2000, 3, 2, 5, 35, 45, 7, 99, 8, 2, 'Strategy',
    '["Carcassonne Series"]', '["Carcassonne Big Box"]', '["Klaus-Jürgen Wrede"]', '["Doris Matthäus"]', '["Hans im Glück"]', '["Tile Placement"]', '["Inns & Cathedrals"]'),

('G0000002', 'Gloomhaven', 119.99, 'Epic campaign game with tactical combat and evolving narrative.', 2017, 1, 1, 4, 90, 150, 14, 99, 3, 1, 'Adventure',
...
('G0000003', 'Ticket to Ride', 44.99, 'Collect train cards to claim railway routes across North America.', 2004, 4, 2, 5, 30, 60, 8, 99, 9, 0, 'Family',
...
('G0000004', '7 Wonders', 34.99, 'Draft cards to build a civilization and wonders.', 2010, 4, 2, 7, 30, 30, 10, 99, 6, 1, 'Civilization',
...
('G0000009', 'Wow', 7.99, 'Cards game where you select the best course of action.', 2025, 2, 3, 6, 30, 120, 18, 99, 3, 0, 'Party',
...
('R0000005', 'U0000004', 'G0000009', 'Repetitve cards.', 2, '2025-01-16 11:32:00');
